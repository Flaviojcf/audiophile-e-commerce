  ...
  return (
    <div className="w-full bg-black50 font-manrope px-10 pb-10 tablet:px-4  tablet:gap-0">
      ...
      <div className="flex gap-16 items-center justify-center text-white  tablet:text-center tablet:gap-0">
        ...
        <div className="flex flex-col  gap-6  h-96 tablet:self-center px-4 tablet:absolute tablet:z-50 tablet:mt-36">
        ...
        <div className="text-white relative tablet:z-10 ">
          <img src="headphone.png" className="opacity-90 rounded-full tablet:hidden" />
          <img src="audiophileTablet.png" className="opacity-90 hidden tablet:flex mobile:hidden" />
          <img src="audiophileMobile.png" className="opacity-90 hidden mobile:flex" />
        </div>
      </div>
    </div>
  );
